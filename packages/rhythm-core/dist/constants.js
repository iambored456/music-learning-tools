...
// Latency Defaults
// ============================================================================
export const DEFAULT_LATENCY_OFFSETS = {
    audioOffsetMs: 0,
    visualOffsetMs: 0,
    inputOffsetMs: 0,
};
...
// ============================================================================
export const DEFAULT_CHART_ADAPTER_CONFIG = {
    tempo: 90,
 ...
 */
export const DEFAULT_BEAT_WINDOW_CONFIG = {
    earlyMarginMs: 80,
    lateMarginMs: 80,
};
// ============================================================================
...
// ============================================================================
export const DEFAULT_REFEREE_CONFIG = {
 ...
 */
export function getMicrobeatDurationMs(tempo) {
 ...
 */
export function getBeatDurationMs(tempo) {
    return 60000 / tempo;
}
/**
 ...
 */
export function getLookaheadMs(tempo, beats = DEFAULT_LOOKAHEAD_BEATS) {
