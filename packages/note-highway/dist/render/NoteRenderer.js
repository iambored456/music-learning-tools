...
export function createNoteRenderer() {
     ...
     * Render all notes.
     */
    function render(ctx, notes, config = {}) {
        const fullConfig = {
     ...
     * Draw a single note.
     */
    function drawNote(ctx, note, config) {
     ...
     */
    function drawStadium(ctx, x, y, width, height, radius, color, config) {
     ...
     * Draw a rectangle.
     */
    function drawRectangle(ctx, x, y, width, height, color, config) {
        ctx.fillStyle = color;
     ...
     */
    function drawOval(ctx, x, y, width, height, color, config) {
     ...
     */
    function getAccuracyColor(baseColor, accuracy) {
        // Parse the hex color
