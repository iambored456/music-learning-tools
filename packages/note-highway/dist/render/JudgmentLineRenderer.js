 ...
 */
export function createJudgmentLineRenderer() {
    /**
     * Render the judgment line.
     */
    function render(ctx, x, viewport, isInTolerance, isVoiced, config = {}) {
        const fullConfig = {
     ...
     */
    function drawGlow(ctx, x, height, isInTolerance, config) {
