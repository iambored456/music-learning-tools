...
// ============================================================================
export const DEFAULT_JUDGMENT_LINE_CONFIG = {
...
// ============================================================================
export const DEFAULT_INPUT_CURSOR_CONFIG = {
    radius: 12,
...
// ============================================================================
export const DEFAULT_INPUT_TRAIL_CONFIG = {
...
// ============================================================================
export const DEFAULT_NOTE_RENDER_CONFIG = {
    glyphStyle: 'stadium',
    noteHeight: 20,
    stadiumRadius: 10,
...
// ============================================================================
export const DEFAULT_GRID_RENDER_CONFIG = {
...
// ============================================================================
export const DEFAULT_TONIC_INDICATOR_CONFIG = {
    enabled: true,
...
// ============================================================================
export const DEFAULT_HIGHWAY_CONFIG = {
 ...
 */
export function calculateScrollConfig(measuresAhead, measureDurationMs, viewportWidth, judgmentLineFraction, msVisibleBehind) {
 ...
 */
export function calculateMidiRange(notes, margin = 3) {
    if (notes.length === 0) {
