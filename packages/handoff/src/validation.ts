 ...
 */
export function validateVoiceMonophonic(voice: SnapshotVoice): OverlapConflict[] {
 ...
 */
export function formatConflictMessage(conflict: OverlapConflict): string {
 ...
 */
export function validateSnapshot(snapshot: SingingTrainerSnapshot): ValidationResult {
  const conflicts: OverlapConflict[] = [];
 ...
 */
export function validateForExport(snapshot: SingingTrainerSnapshot): {
  isValid: boolean;
  summary: string;
