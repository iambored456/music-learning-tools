...
const STANDARD_SETTINGS_SCHEMA: LessonSettingsSchema = {
  fields: [
 ...
 * - Rest (8 microbeats): Silence
 */
export const STANDARD_4_PHASE_PATTERN: ExercisePattern = {
  id: 'standard-4-phase',
 ...
 */
export const QUICK_RESPONSE_PATTERN: ExercisePattern = {
  id: 'quick-response',
  name: 'Quick Response',
  leadInMs: 1500,
  phases: [
 ...
 */
export const EXTENDED_HOLD_PATTERN: ExercisePattern = {
  id: 'extended-hold',
  name: 'Extended Hold',
  leadInMs: 2000,
  phases: [
 ...
 */
export const PITCH_MATCHING_PRESETS: PitchMatchingTemplate[] = [
