...
const FOUNDATIONS_MERGED_PATTERN = {
    ...
    phases: [
        {
            ...
            instructionMessage: "In this lesson, we are not trying to sing correctly. We are learning control with intention. First, turn your voice on and off. Any pitched sound is okay.",
        ...
        { type: 'rest', durationMicrobeats: 8, segmentId: 'foundations-1-1', segmentName: '1.1 Vocal On/Off' },
        {
            ...
            bandRole: 'low',
            instructionMessage: "Great. Now change the sound higher and lower. There is no right note. Just make a clear contrast.",
            speakInstruction: true,
            label: 'LISTEN LOW',
        },
        ...
        { type: 'rest', durationMicrobeats: 8, segmentId: 'foundations-1-2', segmentName: '1.2 High/Low Contrast' },
        {
            ...
            targetMode: 'fixedPitch',
            instructionMessage: 'Nice work. Keep the sound going and slide your pitch up, then down.',
            speakInstruction: true,
            label: 'LISTEN',
        },
        ...
        { type: 'rest', durationMicrobeats: 8, segmentId: 'foundations-1-3', segmentName: '1.3 Pitch Slide' },
        {
            ...
            targetMode: 'fixedPitch',
            instructionMessage: 'Excellent. Now hold one pitch steady. It does not need to be perfect, just controlled.',
            speakInstruction: true,
            label: 'LISTEN',
        },
        ...
        },
        {
            ...
            segmentId: 'foundations-1-4',
            segmentName: '1.4 Hold Steady',
            instructionMessage: 'You learned four core vocal skills: starting sound, changing pitch, moving pitch, and holding pitch.',
            speakInstruction: true,
        },
    ],
};
export const FOUNDATIONS_1_MERGED = {
    id: 'foundations-1-merged',
    name: '1.1-1.4 Foundations Lesson',
    description: 'A single continuous foundations lesson: vocal on/off, high-low contrast, slide control, and hold steady.',
    type: 'pitch-matching',
    difficulty: 1,
