 ...
 */
export type { SpeakingPitchUsage, LessonType, DifficultyLevel, LessonCategory, LessonTemplate, PitchMatchingConfig, LoopPhaseType, LoopPhaseTargetMode, LoopPhase, ExercisePattern, TemplateVariation, PitchMatchingTemplate, TemplateContext, ResolvedConfig, AnyLessonTemplate, SettingFieldType, SettingField, LessonSettingsSchema, LessonStepType, LessonStep, LessonStepper, InstructionStepConfig, InstructionAvatarExpression, ConfigureStepConfig, ListenStepConfig, InputStepConfig, FeedbackStepConfig, CompleteStepConfig, LessonStepConfig, } from './types.js';
